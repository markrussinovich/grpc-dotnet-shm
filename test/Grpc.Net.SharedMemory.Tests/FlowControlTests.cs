...
public class FlowControlTests
{
    ...
    {
        Assert.That(ShmConstants.InitialWindowSize, Is.EqualTo(1024 * 1024 * 1024));
    }
    ...
    [Test]
    [Platform("Win")]
    public void BdpEstimator_BdpLimit_Is1GiB()
    {
    ...
    public void FlowControl_Constants_AreValid()
    {
        ...
        Assert.That(ShmConstants.InitialWindowSize, Is.EqualTo(1024 * 1024 * 1024), "Initial window should be 1 GiB for SHM");
